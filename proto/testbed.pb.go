...
const file_testbed_proto_rawDesc = "" +
	...
	"\x16software_version_value\"\xf7\b\n" +
	"\x04Port\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12)\n" +
	...
	"\x05group\x18\x06 \x01(\tR\x05group\"\x81\x01\n" +
	"\x05Speed\x12\x15\n" +
	...
	"\x06S_40GB\x10(\x12\v\n" +
	"\aS_100GB\x10d\x12\f\n" +
	"\aS_400GB\x10\x90\x03\x12\f\n" +
	"\aS_800GB\x10\xa0\x06\"\xe5\x05\n" +
	"\x03Pmd\x12\x13\n" +
	...
	"\x14PMD_400GBASE_ZR_PLUS\x10\x1f\x12\x13\n" +
	"\x0fPMD_800GBASE_ZR\x10 \x12\x18\n" +
	"\x14PMD_800GBASE_ZR_PLUS\x10!B\x12\n" +
