...
func generateConcreteGraphNodes(dutCount int, ateCount int, atePortsCount int, dutPortsCount int) *ConcreteGraph {
	var (
		nodes       []*ConcreteNode
...
func createAbstractNodesAndEdgesNodes(dutCount int, ateCount int, dutPortsCount int, atePortsCount int) *AbstractGraph {
...
func TestSolveTestNodes(t *testing.T) {
	totalNodes := 1
	ateCount := 10
	dutCount := 10
	atePortsCount := 7
	dutPortsCount := 7
	graph := createAbstractNodesAndEdgesNodes(dutCount, ateCount, dutPortsCount, atePortsCount)
	conGraph := generateConcreteGraphNodes(dutCount, ateCount, atePortsCount, dutPortsCount)
	startTime := time.Now()
