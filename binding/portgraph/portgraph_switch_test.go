...
var (
	...
	switchnode9  = &ConcreteNode{Desc: "switchnode9", Ports: []*ConcretePort{switchnode9port1, switchnode9port2, switchnode9port3, switchnode9port4, switchnode9port5, switchnode9port6, switchnode9port7, switchnode9port8}, Attrs: map[string]string{"role": "L1S", "name": "sw1"}}
	switchnode10 = &ConcreteNode{Desc: "switchnode10", Ports: []*ConcretePort{switchnode10port1, switchnode10port2, switchnode10port3, switchnode10port4, switchnode10port5, switchnode10port6, switchnode10port7, switchnode10port8}, Attrs: map[string]string{"role": "L1S", "name": "sw2"}}
	switchnode11 = &ConcreteNode{Desc: "switchnode11", Ports: []*ConcretePort{switchnode11port1, switchnode11port2, switchnode11port3, switchnode11port4, switchnode11port5}, Attrs: map[string]string{"role": "L1S", "name": "sw3"}}
	switchnode12 = &ConcreteNode{Desc: "switchnode12", Ports: []*ConcretePort{switchnode12port1, switchnode12port2, switchnode12port3, switchnode12port4, switchnode12port5}, Attrs: map[string]string{"role": "L1S", "name": "sw4"}}

	switchnode13 = &ConcreteNode{Desc: "switchnode13", Ports: []*ConcretePort{switchnode13port1, switchnode13port2, switchnode13port3, switchnode13port4, switchnode13port5, switchnode13port6}, Attrs: map[string]string{"role": "L1S", "name": "sw5"}}
	switchnode14 = &ConcreteNode{Desc: "switchnode14", Ports: []*ConcretePort{switchnode14port1, switchnode14port2}, Attrs: map[string]string{"role": "L1S", "name": "sw6"}}
	switchnode15 = &ConcreteNode{Desc: "switchnode15", Ports: []*ConcretePort{switchnode15port1, switchnode15port2}, Attrs: map[string]string{"role": "L1S", "name": "sw7"}}
	switchnode16 = &ConcreteNode{Desc: "switchnode16", Ports: []*ConcretePort{switchnode16port1, switchnode16port2, switchnode16port3, switchnode16port4, switchnode16port5, switchnode16port6}, Attrs: map[string]string{"role": "L1S", "name": "sw8"}}
)
